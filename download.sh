...
# Toolchain
git clone --depth 1 https://github.com/fajar3109/arm-linux-android-4.9 -b main $CIRRUS_WORKING_DIR/GCC-11-32
git clone --depth 1 https://github.com/fajar3109/aarch64-linux-androideabi-4.9 -b main $CIRRUS_WORKING_DIR/GCC-11-64
