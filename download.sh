...
# Toolchain
git clone --depth=1 https://github.com/mvaisakh/gcc-arm.git -b gcc-new $CIRRUS_WORKING_DIR/GCC-11-32
git clone --depth=1 https://github.com/mvaisakh/gcc-arm64.git -b gcc-new $CIRRUS_WORKING_DIR/GCC-11-64
